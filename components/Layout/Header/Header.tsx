...
<div>
        ...
        <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
          <nav className="relative flex items-center justify-between sm:h-20 lg:justify-right" aria-label="Global">
      ...
      <h1 className="uppercase">Spooky season</h1>
            ...
            <div className="hidden md:ml-10 md:block md:space-x-8 md:pr-4">
              ...
              <a href="#" className="font-medium text-gray-500 hover:text-gray-900">Explore</a>
      ...
      <h1 className="uppercase">Spooky season</h1>
            ...
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900">Explore</a>
